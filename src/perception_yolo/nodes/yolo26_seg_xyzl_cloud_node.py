...
# -*- coding: utf-8 -*-
"""
YOLO26-Seg -> XYZL PointCloud2 发布节点
...
输出:
  - /perception/yolo26_seg_cloud (sensor_msgs/PointCloud2, XYZL)
"""
...
class Yolo26SegXYZLCloudNode:
    def __init__(self):
        rospy.init_node("yolo26_seg_xyzl_cloud", anonymous=False)
        ...
        self.cloud_topic = rospy.get_param("~cloud_topic", "/perception/yolo26_seg_cloud")
    ...
    def _callback(self, rgb_msg, depth_msg, camera_info_msg):
        ...
        for result in results:
            ...
            for i, box in enumerate(boxes):
                ...
                label_col = np.full((points_xyz.shape[0], 1), cls_id, dtype=np.float32)
...
python3 /workspace/src/perception_yolo/nodes/yolo26_seg_xyzl_cloud_node.py \
  ...
  _cloud_topic:=/perception/yolo26_seg_cloud \
...
source /opt/ros/noetic/setup.bash &&
export ROS_MASTER_URI=http://127.0.0.1:11311 &&
rostopic echo /perception/yolo26_seg_cloud -n1
"
